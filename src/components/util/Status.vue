...
.status {
  ...
  &.success {
    @apply text-white bg-pruple-light;
    &::before {
      @apply bg-white;
    }
  }
  ...
  &.green {
    @apply text-white bg-green-light;
    &::before {
      @apply bg-white;
    }
  }
  ...
  &.warning {
    @apply text-white bg-yellow-light;
    &::before {
      @apply bg-white;
    }
  }
